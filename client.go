...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("BLUEHIVE_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("BLUE_HIVE_CUSTOM_HEADERS"); ok {
...
// environment (BLUEHIVE_API_KEY, BLUE_HIVE_BASE_URL). The option passed in as
